...
module('Integration | Component | fleetbase-blog', function (hooks) {
    ...
    test('it renders blog posts from the lookup endpoint', async function (assert) {
        ...
        fetch.response = [
            {
                ...
                link: 'https://ubden.com/first-ghost-post',
                pubDate: 'Wed, 06 May 2026 14:31:46 GMT',
            },
            {
                title: 'Second Ghost Post',
                link: 'https://ubden.com/second-ghost-post',
        ...
        assert.dom('.fleetbase-blog').containsText('Ubden TMS Blog');
        ...
        assert.dom('a[href="https://ubden.com/first-ghost-post"]').containsText('First Ghost Post');
        assert.dom('a[href="https://ubden.com/second-ghost-post"]').containsText('Second Ghost Post');
...
module('Integration | Component | fleetbase-blog | loading', function (hooks) {
    ...
    hooks.beforeEach(function () {
        ...
        this.getResponse = [{ title: 'Ubden TMS 0.8', pubDate: '2026-01-15T00:00:00Z' }];
