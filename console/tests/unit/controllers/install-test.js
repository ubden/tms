...
module('Unit | Controller | install', function (hooks) {
    ...
    test('it exposes docs links without installer actions', function (assert) {
        ...
        assert.strictEqual(controller.runningLocallyDocsUrl, 'https://www.ubden.com/docs/platform/quickstart/running-locally');
        assert.strictEqual(controller.cloudDocsUrl, 'https://www.ubden.com/docs/platform/quickstart/deploy-in-cloud');
